...
// ================== 16x16 汉字字模库（阴码、逐列式、顺向、十六进制） ==================
// 每个汉字占 32 字节（16x16 像素）
// 取模规则：阴码、逐列式、顺向、十六进制、16x16
// 注意：以下数据为占位符，需要用字模提取工具（如 PCtoLCD2002）生成真实数据

// 汉字："机" (GB2312: 0xBB, 0xFA)
const uint8_t Chinese_Ji[32] = {
    0x10,0x10,0xD0,0xFF,0x90,0x10,0x00,0xFE,0x02,0x02,0x02,0xFE,0x00,0x00,0x00,0x00,
    0x04,0x03,0x00,0xFF,0x00,0x83,0x60,0x1F,0x00,0x00,0x00,0x3F,0x40,0x40,0x78,0x00
};

// 汉字："房" (GB2312: 0xB7, 0xA8)
const uint8_t Chinese_Fang[32] = {
...
// 汉字："监" (GB2312: 0xBC, 0xE9)
const uint8_t Chinese_Jian[32] = {
...
// 汉字："控" (GB2312: 0xBB, 0xF6)
const uint8_t Chinese_Kong[32] = {
...
// 汉字："温" (GB2312: 0xCE, 0xC2)
const uint8_t Chinese_Wen[32] = {
    0x10,0x60,0x02,0x8C,0x00,0x00,0xFE,0x92,0x92,0x92,0x92,0x92,0xFE,0x00,0x00,0x00,
    0x04,0x04,0x7E,0x01,0x40,0x7E,0x42,0x42,0x7E,0x42,0x7E,0x42,0x42,0x7E,0x40,0x00
};

// 汉字："度" (GB2312: 0xB6, 0xC8)
const uint8_t Chinese_Du[32] = {
    0x00,0x00,0xFC,0x24,0x24,0x24,0xFC,0x25,0x26,0x24,0xFC,0x24,0x24,0x24,0x04,0x00,
    0x40,0x30,0x8F,0x80,0x84,0x4C,0x55,0x25,0x25,0x25,0x55,0x4C,0x80,0x80,0x80,0x00
};

// 汉字："湿" (GB2312: 0xCA, 0xAF)
const uint8_t Chinese_Shi[32] = {
    0x10,0x60,0x02,0x8C,0x00,0xFE,0x92,0x92,0x92,0x92,0x92,0x92,0xFE,0x00,0x00,0x00,
    0x04,0x04,0x7E,0x01,0x44,0x48,0x50,0x7F,0x40,0x40,0x7F,0x50,0x48,0x44,0x40,0x00
};

// 汉字："状" (GB2312: 0xD7, 0xB6)
const uint8_t Chinese_Zhuang[32] = {
...
// 汉字："态" (GB2312: 0xCC, 0xA8)
const uint8_t Chinese_Tai[32] = {
...
// 汉字："正" (GB2312: 0xD5, 0xE2)
const uint8_t Chinese_Zheng[32] = {
...
// 汉字："常" (GB2312: 0xB3, 0xA3)
const uint8_t Chinese_Chang[32] = {
...
// 汉字："警" (GB2312: 0xBE, 0xAB)
const uint8_t Chinese_Jing[32] = {
...
// 汉字："告" (GB2312: 0xB8, 0xF8)
const uint8_t Chinese_Gao[32] = {
...
// ================== 汉字映射表（已适配 UTF-8 编码首两字节） ==================
// 由于 main.c 使用 UTF-8 和 --no_multibyte_chars，汉字会被拆解
// 我们直接提取每个汉字在 UTF-8 编码下的前两个字节作为暗号
typedef struct {
    uint8_t code_h;      // UTF-8 高字节
    uint8_t code_l;      // UTF-8 低字节
    const uint8_t *font; // 字模指针
} Chinese_Font_t;

const Chinese_Font_t Chinese_Font_Map[] = {
    {0xE6, 0x9C, Chinese_Ji},      // 机
    {0xE6, 0x88, Chinese_Fang},    // 房
    {0xE7, 0x9B, Chinese_Jian},    // 监
    {0xE6, 0x8E, Chinese_Kong},    // 控
    {0xE6, 0xB8, Chinese_Wen},     // 温
    {0xE5, 0xBA, Chinese_Du},      // 度
    {0xE6, 0xB9, Chinese_Shi},     // 湿
    {0xE7, 0x8A, Chinese_Zhuang},  // 状
    {0xE6, 0x80, Chinese_Tai},     // 态
    {0xE6, 0xAD, Chinese_Zheng},   // 正
    {0xE5, 0xB8, Chinese_Chang},   // 常
    {0xE8, 0xAD, Chinese_Jing},    // 警
    {0xE5, 0x91, Chinese_Gao}      // 告
};

// 数组大小，供驱动函数遍历使用
const uint16_t Chinese_Font_Map_Size = sizeof(Chinese_Font_Map) / sizeof(Chinese_Font_Map[0]);
